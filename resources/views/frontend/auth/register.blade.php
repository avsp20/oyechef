...
@section('content')
<form class="" method="POST" action="{{ route('register.submit') }}">
    @csrf
    <div class="form-title">
        <h2>Sign Up</h2>
        <p>Already have an account? <a href="{{ route('front.login') }}" class="form-link fw-500"> Sign In</a></p>
    </div>
    <div class="form-content">
        <div class="form-left">
            ...
            <div class="form-group">
                ...
                <input type="password" name="cpassword" class="form-control" id="cpassword" placeholder="**********" value="{{ old('cpassword') }}">
    ...
    <div class="form-bottom">
        <p>
            *By signing up, you agree  to our <a href="{{ route('front.terms-and-conditions') }}" class="form-link" target="_blank">Terms of use</a> and to recieve OyeChef
            emails & updates and acknowledge that you read our <a href="{{ route('front.privacy-policy') }}" target="_blank" class="form-link">Privacy Policy</a>.
        </p>
        <p>
